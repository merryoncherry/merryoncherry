...
subprocess.run([
    ...
    "--layout="+srcrgb,
    "--outlayout="+intrgb,
    "--edit=InGroup=OnlyForXmas:Delete:true;InGroup=OnlyForFuture:Delete:true;Type=Obj:Brighten:30;Obj=.*_Xmas:Active:false;Model=.*:dimcurveall:0,2.2;Model=TreeFence:dimcurvergb:-14,2.2,0,2.2,0,2.2;Model=MainMatrix:dimcurveall:-60,2.2;Model=Arch Hedge.*:dimcurveall:-60,2.2;Model=PPD GE Baby Grand.*:dimcurveall:-30,2.2;Model=GE Dragonfly.*:dimcurveall:0,2.5;Model=GE Franken Monster.*:dimcurveall:0,2.5;Model=GE Priem Cube.*:dimcurveall:0,2.5;Model=Matrix KBR Window.*:dimcurveall:0,2.5;Model=MatrixFWall.*:dimcurveall:0,2.5;Model=MatrixPost.*:dimcurveall:0,2.5;Model=MatrixSideDoor.*:dimcurveall:0,2.5;Model=PPD GE Baby Grand Illusion.*:dimcurveall:0,2.5;Model=StarF.*:dimcurveall:0,2.5;Model=GE Triune Tomb.*:dimcurveall:0,2.5;Model=GE Insane.*:dimcurveall:0,1.0;Model=DmxWands:dimcurveall:0,2.2;Model=DmxWandsCtrl:dimcurveall:0,1.0",
