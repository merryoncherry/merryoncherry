...
directionY = 2
linePixels = 95
mname = "HalloweenVerticalPixelTrim"
...
# This loads the prop
with open('BioFlakeHoriz.xmodel', newline='') as modelfile:
    dom = xml.dom.minidom.parse(modelfile)
    props.append(Prop(dom, 4, -3, 0, 9, 10))

with open('RadioFlakeHoriz.xmodel', newline='') as modelfile:
    dom = xml.dom.minidom.parse(modelfile)
    props.append(Prop(dom, -6, -2, 3, 9, 10))
