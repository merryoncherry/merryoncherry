...
netsh interface ipv4 add neighbors "USBHub27" "192.168.27.136" "80-f5-b5-e0-cb-64"
netsh interface ipv4 add neighbors "USBHub27" "192.168.27.150" "60-b6-e1-17-e6-5d"
netsh interface ipv4 add neighbors "USBHub27" "192.168.27.156" "98-f0-7b-a8-85-3f"
